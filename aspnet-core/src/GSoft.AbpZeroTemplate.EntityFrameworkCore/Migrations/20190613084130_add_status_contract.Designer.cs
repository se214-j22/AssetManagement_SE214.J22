...
namespace GSoft.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20190613084130_add_status_contract")]
    partial class add_status_contract
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.BidProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("BidCatalog");
                    ...
                    b.ToTable("BidProfiles");
                });

            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.BidUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("BeginCost");

                    b.Property<int>("BidProfileId");

                    b.Property<string>("Note");

                    b.Property<int>("ProductId");

                    b.Property<string>("ProofNum");
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CalUnit = "unit", Code = "DELL-PJ", CreateDate = new DateTime(2019, 6, 13, 15, 41, 29, 220, DateTimeKind.Local), Name = "Dell Projector", ProductTypeId = 1, Status = 1, SupplierId = 1, UnitPrice = 1E+07f }
                    );
                });
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.ProductType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "PJ001", Name = "Projector", Note = "", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.SubPlan", b =>
                {
                    ...
                    b.Property<float>("ImplementPrice");

                    b.Property<int>("ImplementQantity");

                    b.Property<float>("PesidualPrice");

                    b.Property<int>("PesidualQuantity");
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Supplier", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "DELL001", CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "DELL", Status = 1, SupplierTypeId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.SupplierType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Code = "SA001", Name = "Electronic", Note = "", Status = 1 }
                    );
                });
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.BidProfile", b =>
                {
                    ...
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.Project", "Project")
                        .WithMany("BidProfiles")
                        .HasForeignKey("ProjectId");
                });

            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.BidUnit", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.BidProfile", "BidProfile")
                        .WithMany("BidUnits")
                        .HasForeignKey("BidProfileId")
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Contract", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.BidProfile", "BidProfile")
                        .WithOne("Contract")
                        .HasForeignKey("GWebsite.AbpZeroTemplate.Core.Models.Contract", "BidProfileId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.SubPlan", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.Plan", "Plan")
                        .WithMany("SubPlans")
