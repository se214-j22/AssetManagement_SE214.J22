...
namespace GSoft.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20190614184259_AddSomeFiledForReport")]
    partial class AddSomeFiledForReport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Asset", b =>
                {
                    ...
                    b.HasIndex("AssetLineId");

                    b.ToTable("Assets");
                });

            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.AssetLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("AssetLines");
                });

            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.AssetOrganizationUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("AssetOrganizationUnits");
                });
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.Asset", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.AssetLine", "AssetLine")
                        .WithMany()
                        .HasForeignKey("AssetLineId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.AssetLine", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.AssetType", "AssetType")
                        .WithMany()
                        .HasForeignKey("AssetTypeID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.Manufacturer", "Manufacturer")
                        .WithMany()
            ...
            modelBuilder.Entity("GWebsite.AbpZeroTemplate.Core.Models.AssetOrganizationUnit", b =>
                {
                    b.HasOne("GWebsite.AbpZeroTemplate.Core.Models.Asset", "Asset")
                        .WithMany()
