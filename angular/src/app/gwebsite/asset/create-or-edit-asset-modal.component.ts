...
import { CustomerServiceProxy, CustomerInput, AssetInput, AssetServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditAssetModalComponent extends AppComponentBase {
    ...
    show(assetId?: number | null | undefined): void {
        ...
        this._assetService.getForEdit(assetId).subscribe(result => {
            this.asset = result;
            this.modal.show();
