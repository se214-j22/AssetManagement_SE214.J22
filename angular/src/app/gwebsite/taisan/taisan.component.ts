...
export class TaiSanComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    reloadList(TenTaiSan, event?: LazyLoadEvent) {
        this._taiSanService.getTaiSansByFilter(TenTaiSan, this.primengTableHelper.getSorting(this.dataTable),
    ...
    init(): void {
        ...
        this._activatedRoute.params.subscribe((params: Params) => {
            ...
            this.reloadList(this.TenTaiSan, null);
        });
    }
