import { ViewCapPhatModalComponent } from './view-capphat-modal.component';
...
import { CreateOrEditCapPhatModalComponent } from './create-or-edit-capphat-modal.component';

@Component({
    templateUrl: './capphat.component.html',
    animations: [appModuleAnimation()]
})
export class CapPhatComponent extends AppComponentBase implements AfterViewInit, OnInit {
    ...
    reloadList(tenDonVi, event?: LazyLoadEvent) {
        this._capPhatService.getCapPhatsByFilter(tenDonVi, this.primengTableHelper.getSorting(this.dataTable),
