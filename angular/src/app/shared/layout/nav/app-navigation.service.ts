    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [
                ...
                new AppMenuItem('BDS', 'Pages.Administration.Customer', 'flaticon-menu-1', '/app/gwebsite/BDS'),
                new AppMenuItem('BDS_SuaChua', 'Pages.Administration.Customer_SuaChua', 'flaticon-menu-1', '/app/gwebsite/BDS_SuaChua'),
                new AppMenuItem('BDS_QuanLyCongTrinhXayDung', 'Pages.Administration.Customer_QuanLyCongTrinhXayDung', 'flaticon-menu-1', '/app/gwebsite/BDS_QuanLyCongTrinhXayDung')
            ]),
