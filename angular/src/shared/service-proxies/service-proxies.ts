...
export class ScanReportServiceProxy {
    ...
    getScanReportsByFilter(scannedData: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfScanReportDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetScanReportsByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScanReportsByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfScanReportDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfScanReportDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetScanReportsByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfScanReportDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<PagedResultDtoOfScanReportDto>(<any>null);
    }
     ...
     * @return Success
     */
    getScanReportForEdit(id: number | null | undefined): Observable<ScanReportInput> {
        let url_ = this.baseUrl + "/api/ScanReport/GetScanReportForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetScanReportForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScanReportForEdit(<any>response_);
                } catch (e) {
                    return <Observable<ScanReportInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ScanReportInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetScanReportForEdit(response: HttpResponseBase): Observable<ScanReportInput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ScanReportInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditScanReport(input: ScanReportInput | null | undefined): Observable<ScanReportDto> {
        let url_ = this.baseUrl + "/api/ScanReport/CreateOrEditScanReport";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processCreateOrEditScanReport(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditScanReport(<any>response_);
                } catch (e) {
                    return <Observable<ScanReportDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ScanReportDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreateOrEditScanReport(response: HttpResponseBase): Observable<ScanReportDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ScanReportDto>(<any>null);
    }

    /**
     * @return Success
     */
    deleteScanReport(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/ScanReport/DeleteScanReport/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processDeleteScanReport(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteScanReport(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteScanReport(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getScanReportForView(id: number | null | undefined): Observable<ScanReportForViewDto> {
        let url_ = this.baseUrl + "/api/ScanReport/GetScanReportForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetScanReportForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScanReportForView(<any>response_);
                } catch (e) {
                    return <Observable<ScanReportForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ScanReportForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetScanReportForView(response: HttpResponseBase): Observable<ScanReportForViewDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ScanReportForViewDto>(<any>null);
    }
}
...
export class PagedResultDtoOfScanReportDto implements IPagedResultDtoOfScanReportDto {
    totalCount!: number | undefined;
    items!: ScanReportDto[] | undefined;

    constructor(data?: IPagedResultDtoOfScanReportDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(ScanReportDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfScanReportDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfScanReportDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfScanReportDto {
    totalCount: number | undefined;
    items: ScanReportDto[] | undefined;
}
...
export class ScanReportDto implements IScanReportDto {
    ...
    static fromJS(data: any): ScanReportDto {
        data = typeof data === 'object' ? data : {};
        let result = new ScanReportDto();
        result.init(data);
        return result;
    }
...
export class ScanReportInput implements IScanReportInput {
    ...
    constructor(data?: IScanReportInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ScanReportInput {
        data = typeof data === 'object' ? data : {};
        let result = new ScanReportInput();
        result.init(data);
        return result;
    }
...
export interface IScanReportInput {
    scannedData: string | undefined;
    id: number | undefined;
}
...
export class ScanReportForViewDto implements IScanReportForViewDto {
    ...
    static fromJS(data: any): ScanReportForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new ScanReportForViewDto();
        result.init(data);
        return result;
    }
