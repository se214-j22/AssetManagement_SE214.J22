...
export class TaiSanServiceProxy {
     ...
     * @return Success
     */
    getTaiSansByFilter(tenTaiSan: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfTaiSanDto> {
...
export class CapPhatServiceProxy {
     ...
     * @return Success
     */
    getCapPhatsByFilter(tenDonVi: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCapPhatDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfCapPhatDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCapPhatDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetCapPhatsByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfCapPhatDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = resultData200 ? PagedResultDtoOfCapPhatDto.fromJS(resultData200) : new PagedResultDtoOfCapPhatDto();
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfCapPhatDto>(<any>null);
    }
...
//region CapPhat
export class PagedResultDtoOfCapPhatDto implements IPagedResultDtoOfCapPhatDto {
    totalCount!: number | undefined;
    items!: CapPhatDto[] | undefined;

    constructor(data?: IPagedResultDtoOfCapPhatDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(CapPhatDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfCapPhatDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfCapPhatDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfCapPhatDto {
    totalCount: number | undefined;
    items: CapPhatDto[] | undefined;
}
...
export class CapPhatDto implements ICapPhatDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.ngayCapPhat = data["ngayCapPhat"];            
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["ngayCapPhat"] = this.ngayCapPhat;
        data["id"] = this.id;
        return data;
    }
}
