...
export class AssetServiceProxy {
     ...
     * @return Success
     */
    create(input: AssetInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Asset/Create";
        url_ = url_.replace(/[?&]$/, "");
