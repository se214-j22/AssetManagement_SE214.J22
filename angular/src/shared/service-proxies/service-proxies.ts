...
export class CustomerServiceProxy {
    ...
    //BDS_SuaChua
    getCustomersByFilter_SuaChua(name: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCustomerDto_SuaChua> {
        let url_ = this.baseUrl + "/api/Customer_SuaChua/GetCustomersByFilter?";
        if (name !== undefined)
            url_ += "maBDS=" + encodeURIComponent("" + name) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomersByFilter_SuaChua(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomersByFilter_SuaChua(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfCustomerDto_SuaChua>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCustomerDto_SuaChua>><any>_observableThrow(response_);
        }));
    }
     //BDS_QuanLyCongTrinhXayDung
     getCustomersByFilter_QuanLyCongTrinhXayDung(name: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung> {
        let url_ = this.baseUrl + "/api/Customer_QuanLyCongTrinhXayDung/GetCustomersByFilter?";
        if (name !== undefined)
            url_ += "maBDS=" + encodeURIComponent("" + name) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomersByFilter_QuanLyCongTrinhXayDung(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomersByFilter_QuanLyCongTrinhXayDung(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung>><any>_observableThrow(response_);
        }));
    }
    ...
    //BDS_SuaChua
    protected processGetCustomersByFilter_SuaChua(response: HttpResponseBase): Observable<PagedResultDtoOfCustomerDto_SuaChua> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfCustomerDto_SuaChua.fromJS(resultData200) : new PagedResultDtoOfCustomerDto_SuaChua();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfCustomerDto_SuaChua>(<any>null);
    }
     //BDS_QuanLyCongTrinhXayDung
     protected processGetCustomersByFilter_QuanLyCongTrinhXayDung(response: HttpResponseBase): Observable<PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung.fromJS(resultData200) : new PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung>(<any>null);
    }
    ...
    //BDS_SuaChua
    getCustomerForEdit_SuaChua(id: number | null | undefined): Observable<CustomerInput_SuaChua> {
        let url_ = this.baseUrl + "/api/Customer_SuaChua/GetCustomerForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerForEdit_SuaChua(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerForEdit_SuaChua(<any>response_);
                } catch (e) {
                    return <Observable<CustomerInput_SuaChua>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomerInput_SuaChua>><any>_observableThrow(response_);
        }));
    }
     //BDS_QuanLyCongTrinhXayDung
     getCustomerForEdit_QuanLyCongTrinhXayDung(id: number | null | undefined): Observable<CustomerInput_QuanLyCongTrinhXayDung> {
        let url_ = this.baseUrl + "/api/Customer_QuanLyCongTrinhXayDung/GetCustomerForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerForEdit_QuanLyCongTrinhXayDung(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerForEdit_QuanLyCongTrinhXayDung(<any>response_);
                } catch (e) {
                    return <Observable<CustomerInput_QuanLyCongTrinhXayDung>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomerInput_QuanLyCongTrinhXayDung>><any>_observableThrow(response_);
        }));
    }
    ...
    //BDS_SuaChua
    protected processGetCustomerForEdit_SuaChua(response: HttpResponseBase): Observable<CustomerInput_SuaChua> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomerInput_SuaChua.fromJS(resultData200) : new CustomerInput_SuaChua();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomerInput_SuaChua>(<any>null);
    }
     //BDS_QuanLyCongTrinhXayDung
     protected processGetCustomerForEdit_QuanLyCongTrinhXayDung(response: HttpResponseBase): Observable<CustomerInput_QuanLyCongTrinhXayDung> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomerInput_QuanLyCongTrinhXayDung.fromJS(resultData200) : new CustomerInput_QuanLyCongTrinhXayDung();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomerInput_QuanLyCongTrinhXayDung>(<any>null);
    }
    ...
    //BDS_SuaChua
    createOrEditCustomer_SuaChua(input: CustomerInput_SuaChua | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Customer_SuaChua/CreateOrEditCustomer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditCustomer_SuaChua(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditCustomer_SuaChua(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    //BDS_QuanLyCongTrinhXayDung
    createOrEditCustomer_QuanLyCongTrinhXayDung(input: CustomerInput_QuanLyCongTrinhXayDung | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Customer_QuanLyCongTrinhXayDung/CreateOrEditCustomer";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditCustomer_QuanLyCongTrinhXayDung(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditCustomer_QuanLyCongTrinhXayDung(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    //BDS_SuaChua
    protected processCreateOrEditCustomer_SuaChua(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     //BDS_QuanLyCongTrinhXayDung
     protected processCreateOrEditCustomer_QuanLyCongTrinhXayDung(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    //BDS_SuaChua
    deleteCustomer_SuaChua(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Customer_SuaChua/DeleteCustomer/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCustomer_SuaChua(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCustomer_SuaChua(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     //BDS_SuaChua
     deleteCustomer_QuanLyCongTrinhXayDung(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Customer_QuanLyCongTrinhXayDung/DeleteCustomer/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteCustomer_QuanLyCongTrinhXayDung(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteCustomer_QuanLyCongTrinhXayDung(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    //BDS_SuaChua
    protected processDeleteCustomer_SuaChua(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     //BDS_QuanLyCongTrinhXayDung
     protected processDeleteCustomer_QuanLyCongTrinhXayDung(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    //BDS_SuaChua
    getCustomerForView_SuaChua(id: number | null | undefined): Observable<CustomerForViewDto_SuaChua> {
        let url_ = this.baseUrl + "/api/Customer_SuaChua/GetCustomerForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerForView_SuaChua(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerForView_SuaChua(<any>response_);
                } catch (e) {
                    return <Observable<CustomerForViewDto_SuaChua>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomerForViewDto_SuaChua>><any>_observableThrow(response_);
        }));
    }
    //BDS_QuanLyCongTrinhXayDung
    getCustomerForView_QuanLyCongTrinhXayDung(id: number | null | undefined): Observable<CustomerForViewDto_QuanLyCongTrinhXayDung> {
        let url_ = this.baseUrl + "/api/Customer_QuanLyCongTrinhXayDung/GetCustomerForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerForView_QuanLyCongTrinhXayDung(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerForView_QuanLyCongTrinhXayDung(<any>response_);
                } catch (e) {
                    return <Observable<CustomerForViewDto_QuanLyCongTrinhXayDung>><any>_observableThrow(e);
                }
            } else
                return <Observable<CustomerForViewDto_QuanLyCongTrinhXayDung>><any>_observableThrow(response_);
        }));
    }
    ...
    //BDS_SuaChua
    protected processGetCustomerForView_SuaChua(response: HttpResponseBase): Observable<CustomerForViewDto_SuaChua> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomerForViewDto_SuaChua.fromJS(resultData200) : new CustomerForViewDto_SuaChua();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomerForViewDto_SuaChua>(<any>null);
    }
     //BDS_QuanLyCongTrinhXayDung
     protected processGetCustomerForView_QuanLyCongTrinhXayDung(response: HttpResponseBase): Observable<CustomerForViewDto_QuanLyCongTrinhXayDung> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CustomerForViewDto_QuanLyCongTrinhXayDung.fromJS(resultData200) : new CustomerForViewDto_QuanLyCongTrinhXayDung();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CustomerForViewDto_QuanLyCongTrinhXayDung>(<any>null);
    }
}
...
//BDS_SuaChua
export class PagedResultDtoOfCustomerDto_SuaChua implements IPagedResultDtoOfCustomerDto_SuaChua {
    totalCount!: number | undefined;
    items!: CustomerDto_SuaChua[] | undefined;

    constructor(data?: IPagedResultDtoOfCustomerDto_SuaChua) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(CustomerDto_SuaChua.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfCustomerDto_SuaChua {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfCustomerDto_SuaChua();
        result.init(data);
        return result;
    }
...
//BDS_QuanLyCongTrinhXayDung
export class PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung implements IPagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung {
    totalCount!: number | undefined;
    items!: CustomerDto_QuanLyCongTrinhXayDung[] | undefined;

    constructor(data?: IPagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(CustomerDto_QuanLyCongTrinhXayDung.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung();
        result.init(data);
        return result;
    }
...
//BDS_SuaChua
export interface IPagedResultDtoOfCustomerDto_SuaChua {
    totalCount: number | undefined;
    items: CustomerDto_SuaChua[] | undefined;
}
//BDS_QuanLyCongTrinhXayDung
export interface IPagedResultDtoOfCustomerDto_QuanLyCongTrinhXayDung {
    totalCount: number | undefined;
    items: CustomerDto_QuanLyCongTrinhXayDung[] | undefined;
}
export class CustomerDto implements ICustomerDto {
    maBDS!: string | undefined;
    tenBDS!: string | undefined;
    loaiBDS!: string | undefined;
    nhomBDS!: string | undefined;
    id!: number | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.tenBDS = data["tenBDS"];
            this.loaiBDS = data["loaiBDS"];
            this.nhomBDS = data["nhomBDS"];
            this.id = data["id"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["tenBDS"] = this.tenBDS;
        data["loaiBDS"] = this.loaiBDS;
        data["nhomBDS"] = this.nhomBDS;
        data["id"] = this.id;
        return data; 
    }
}
//BDS_SuaChua
export class CustomerDto_SuaChua implements ICustomerDto_SuaChua {
    maBDS!: string | undefined;
    ngayXuat!: string | undefined;
    ngaySuaXong!: string | undefined;
    tenBDS!: string | undefined;
    nguoiDeXuat!: string | undefined;
    nvPhuTrach!: string | undefined;
    trangThaiDuyet!: string | undefined;
    
    id!: number | undefined;

    constructor(data?: ICustomerDto_SuaChua) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.tenBDS = data["tenBDS"];
            this.nguoiDeXuat = data["nguoiDeXuat"];
    ...
    static fromJS(data: any): CustomerDto_SuaChua {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerDto_SuaChua();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["nguoiDeXuat"] = this.nguoiDeXuat;
...
//BDS_QuanLyCongTrinhXayDung
export class CustomerDto_QuanLyCongTrinhXayDung implements ICustomerDto_QuanLyCongTrinhXayDung {
    maBDS!: string | undefined;
    TenCongTrinh!: string | undefined;
    DiaChiCongTrinh!: string | undefined;
    DienTichCongTrinh!: string | undefined;
    LoaiThucHienCongTrinh!: string | undefined;
    ChiPhiDuToanBanDau!: string | undefined;
    ChiPhiThucHien!: string | undefined;
    ChiPhiPhatSinh!: string | undefined;
    MoTaCongTrinh!: string | undefined;
    ThoiGianDuKienHoanThanh!: string | undefined;
    ThoiGianHoanThanh!: string | undefined;
    TienDoCongTrinh!: string | undefined;
    
    id!: number | undefined;

    constructor(data?: ICustomerDto_QuanLyCongTrinhXayDung) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.DiaChiCongTrinh = data["diaChiCongTrinh"];
            this.DienTichCongTrinh = data["dienTichCongTrinh"];
            this.LoaiThucHienCongTrinh = data["loaiThucHienCongTrinh"];
            this.ChiPhiDuToanBanDau = data["chiPhiDuToanBanDau"];
            this.ChiPhiThucHien = data["chiPhiThucHien"];
            this.ChiPhiPhatSinh = data["chiPhiPhatSinh"];
            this.MoTaCongTrinh = data["moTaCongTrinh"];
            this.ThoiGianDuKienHoanThanh = data["thoiGianDuKienHoanThanh"];
            this.ThoiGianHoanThanh = data["thoiGianHoanThanh"];
            this.TienDoCongTrinh = data["tienDoCongTrinh"];

            this.id = data["id"];
        }
    }

    static fromJS(data: any): CustomerDto_QuanLyCongTrinhXayDung {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerDto_QuanLyCongTrinhXayDung();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["loaiThucHienCongTrinh"]= this.LoaiThucHienCongTrinh;
        data["chiPhiDuToanBanDau"]= this.ChiPhiDuToanBanDau;
         data["chiPhiThucHien"]=this.ChiPhiThucHien;
         data["chiPhiPhatSinh"]=this.ChiPhiPhatSinh;
         data["moTaCongTrinh"]=this.MoTaCongTrinh;
        data["thoiGianDuKienHoanThanh"]= this.ThoiGianDuKienHoanThanh;
         data["thoiGianHoanThanh"]=this.ThoiGianHoanThanh;
         data["tienDoCongTrinh"]=this.TienDoCongTrinh;
...
//BDS_SuaChua
export interface ICustomerDto_SuaChua {
    maBDS: string | undefined;
    ngayXuat: string | undefined;
    ngaySuaXong: string | undefined;
    tenBDS: string | undefined;
...
//BDS_QuanLyCongTrinhXayDung
export interface ICustomerDto_QuanLyCongTrinhXayDung {
    maBDS: string | undefined;
    TenCongTrinh: string | undefined;
    DiaChiCongTrinh: string | undefined;
    DienTichCongTrinh: string | undefined;
...
export class CustomerInput implements ICustomerInput {
    ...
    hienTrang!: string | undefined;
    dienTich!: string | undefined;
    dai!: string | undefined;
    rong!: string | undefined;
    thoiHanSD!: string | undefined;
    tinhTrangSD!: string | undefined;
    ketCauNha!: string | undefined;
    ranhGioi!: string | undefined;
    tinhTrangPhapLy!: string | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            this.hienTrang = data["hienTrang"];
            this.dienTich = data["dienTich"];
            this.dai = data["dai"];
            this.rong = data["rong"];
            this.thoiHanSD = data["thoiHanSD"];
            this.tinhTrangSD = data["tinhTrangSD"];
            this.ketCauNha = data["ketCauNha"];
            this.ranhGioi = data["ranhGioi"];
            this.tinhTrangPhapLy = data["tinhtrangPhapLy"];
...
//BDS_SuaChua
export class CustomerInput_SuaChua implements ICustomerInput_SuaChua {
    maBDS!: string | undefined;
    ngayXuat!: string | undefined;
    ngaySuaXong!: string | undefined;
    tenBDS!: string | undefined;
    ...
    constructor(data?: ICustomerInput_SuaChua) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomerInput_SuaChua {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerInput_SuaChua();
        result.init(data);
        return result;
    }
...
//BDS_QuanLyCongTrinhXayDung
export class CustomerInput_QuanLyCongTrinhXayDung implements ICustomerInput_QuanLyCongTrinhXayDung {
    maBDS!: string | undefined;
    TenCongTrinh!: string | undefined;
    DiaChiCongTrinh!: string | undefined;
    DienTichCongTrinh!: string | undefined;
    ...
    SoToTrinh!: string | undefined;
    ChiPhiDuKien!: string | undefined;
    ChiPhiDuocDuyet!: string | undefined;

    MaGoiThau!: string | undefined;
    TenHangMucGoiThau!: string | undefined;
    DonViTrungThau!: string | undefined;
    GiaTriChaoThau!: string | undefined;
    NgayNopHoSoThau!: string | undefined;
    ThoiGianThiCong!: string | undefined;
    ThongTinDonViThamGiaThau!: string | undefined;

    TongGiaTriHopDong!: string | undefined;
    GiaTriDaThanhToanCuaHopDong!: string | undefined;
    TienDoThiCong!: string | undefined;
    ThoiGianThanhToan!: string | undefined;

    id!: number | undefined;

    constructor(data?: ICustomerInput_QuanLyCongTrinhXayDung) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.TenHangMucGoiThau = data["tenHangMucGoiThau"];
            this.DonViTrungThau = data["donViTrungThau"];
            this.GiaTriChaoThau = data["giaTriChaoThau"];
            this.NgayNopHoSoThau = data["ngayNopHoSoThau"];
            this.ThoiGianThiCong = data["thoiGianThiCong"];
            this.ThongTinDonViThamGiaThau = data["thongTinDonViThamGiaThau"];

            this.TongGiaTriHopDong = data["tongGiaTriHopDong"];
            this.GiaTriDaThanhToanCuaHopDong = data["giaTriDaThanhToanCuaHopDong"];
            this.TienDoThiCong = data["tienDoThiCong"];
            this.ThoiGianThanhToan = data["thoiGianThanhToan"];

            this.id = data["id"];
        }
    }

    static fromJS(data: any): CustomerInput_QuanLyCongTrinhXayDung {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerInput_QuanLyCongTrinhXayDung();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["tienDoCongTrinh"]= this.TienDoCongTrinh;
         ...
         data["soToTrinh"]=this.SoToTrinh;
         data["chiPhiDuKien"]=this.ChiPhiDuKien ;
         data["chiPhiDuocDuyet"]=this.ChiPhiDuocDuyet;

        data["maGoiThau"]= this.MaGoiThau ;
         data["tenHangMucGoiThau"]=this.TenHangMucGoiThau;
         data["donViTrungThau"]=this.DonViTrungThau ;
         data["giaTriChaoThau"]=this.GiaTriChaoThau;
         data["ngayNopHoSoThau"]=this.NgayNopHoSoThau;
         data["thoiGianThiCong"]=this.ThoiGianThiCong;
         data["thongTinDonViThamGiaThau"]=this.ThongTinDonViThamGiaThau;

         data["tongGiaTriHopDong"]=this.TongGiaTriHopDong ;
         data["giaTriDaThanhToanCuaHopDong"]=this.GiaTriDaThanhToanCuaHopDong ;
         data["tienDoThiCong"]=this.TienDoThiCong ;
...
//BDS_SuaChua
export interface ICustomerInput_SuaChua {
    maBDS: string | undefined;
    ngayXuat: string | undefined;
    ngaySuaXong: string | undefined;
    tenBDS: string | undefined;
...
//BDS_QuanLyCongTrinhXayDung
export interface ICustomerInput_QuanLyCongTrinhXayDung {
    maBDS: string | undefined;
    TenCongTrinh: string | undefined;
    DiaChiCongTrinh: string | undefined;
    DienTichCongTrinh: string | undefined;
...
//BDS_SuaChua
export class CustomerForViewDto_SuaChua implements ICustomerForViewDto_SuaChua {
    maBDS!: string | undefined;
    ngayXuat!: string | undefined;
    ngaySuaXong!: string | undefined;
    tenBDS!: string | undefined;
    ...
    constructor(data?: ICustomerForViewDto_SuaChua) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomerForViewDto_SuaChua {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerForViewDto_SuaChua();
        result.init(data);
        return result;
    }
...
//BDS_QuanLyCongTrinhXayDung
export class CustomerForViewDto_QuanLyCongTrinhXayDung implements ICustomerForViewDto_QuanLyCongTrinhXayDung {
    maBDS!: string | undefined;
    TenCongTrinh!: string | undefined;
    DiaChiCongTrinh!: string | undefined;
    DienTichCongTrinh!: string | undefined;
    ...
    constructor(data?: ICustomerForViewDto_QuanLyCongTrinhXayDung) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomerForViewDto_QuanLyCongTrinhXayDung {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerForViewDto_QuanLyCongTrinhXayDung();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["maGoiThau"]= this.MaGoiThau ;
         ...
         data["tongGiaTriHopDong"]=this.TongGiaTriHopDong ;
         data["tiaTriDaThanhToanCuaHopDong"]=this.GiaTriDaThanhToanCuaHopDong ;
         data["tienDoThiCong"]=this.TienDoThiCong ;
         data["thoiGianThanhToan"]=this.ThoiGianThanhToan ;
...
//BDS_SuaChua
export interface ICustomerForViewDto_SuaChua {
    maBDS: string | undefined;
    ngayXuat: string | undefined;
    ngaySuaXong: string | undefined;
    tenBDS: string | undefined;
...
//BDS_QuanLyCongTrinhXayDung
export interface ICustomerForViewDto_QuanLyCongTrinhXayDung {
    maBDS: string | undefined;
    TenCongTrinh: string | undefined;
    DiaChiCongTrinh: string | undefined;
    DienTichCongTrinh: string | undefined;
