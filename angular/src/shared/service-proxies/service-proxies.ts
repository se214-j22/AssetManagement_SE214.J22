...
export class AssetServiceProxy {
    ...
    /**
     * @term (optional) 
     * @assetLineId (optional) 
     * @sorting (optional) 
     * @maxResultCount (optional) 
     * @skipCount (optional) 
     * @return Success
     */
    getByFilter(term: string | null | undefined, assetLineId: number | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfAssetDto> {
        let url_ = this.baseUrl + "/api/Asset/GetByFilter?";
        if (term !== undefined)
            url_ += "Term=" + encodeURIComponent("" + term) + "&"; 
        if (assetLineId !== undefined)
            url_ += "AssetLineId=" + encodeURIComponent("" + assetLineId) + "&"; 
    ...
    protected processGetByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfAssetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<AssetDto> {
        let url_ = this.baseUrl + "/api/Asset/GetById?";
        if (id !== undefined)
    ...
    protected processGetById(response: HttpResponseBase): Observable<AssetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getByCode(code: string | null | undefined): Observable<AssetDto> {
        let url_ = this.baseUrl + "/api/Asset/GetByCode?";
        if (code !== undefined)
    ...
    protected processGetByCode(response: HttpResponseBase): Observable<AssetDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<AssetInput> {
        let url_ = this.baseUrl + "/api/Asset/GetForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetForEdit(response: HttpResponseBase): Observable<AssetInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createOrEdit(input: AssetInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Asset/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Asset/Delete/{id}";
...
@Injectable()
export class AssetLineServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getByFilter(term: string | null | undefined, assetTypeId: number | null | undefined, manufacturerId: number | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfAssetLineDto> {
        let url_ = this.baseUrl + "/api/AssetLine/GetByFilter?";
        if (term !== undefined)
            url_ += "Term=" + encodeURIComponent("" + term) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfAssetLineDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfAssetLineDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfAssetLineDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfAssetLineDto.fromJS(resultData200) : new PagedResultDtoOfAssetLineDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfAssetLineDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<AssetLineDto> {
        let url_ = this.baseUrl + "/api/AssetLine/GetById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AssetLineDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AssetLineDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<AssetLineDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? AssetLineDto.fromJS(resultData200) : new AssetLineDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AssetLineDto>(<any>null);
    }
     ...
     * @return Success
     */
    getByCode(code: string | null | undefined): Observable<AssetLineDto> {
        let url_ = this.baseUrl + "/api/AssetLine/GetByCode?";
        if (code !== undefined)
            url_ += "code=" + encodeURIComponent("" + code) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetByCode(response: HttpResponseBase): Observable<AssetLineDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<AssetLineInput> {
        let url_ = this.baseUrl + "/api/AssetLine/GetForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AssetLineInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<AssetLineInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<AssetLineInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? AssetLineInput.fromJS(resultData200) : new AssetLineInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AssetLineInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: AssetLineInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/AssetLine/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/AssetLine/Delete/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
...
export class AssetTypeServiceProxy {
     ...
     * @return Success
     */
    getByFilter(term: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfAssetTypeDto> {
        let url_ = this.baseUrl + "/api/AssetType/GetByFilter?";
        if (term !== undefined)
            url_ += "Term=" + encodeURIComponent("" + term) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfAssetTypeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfAssetTypeDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfAssetTypeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<PagedResultDtoOfAssetTypeDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<AssetTypeDto> {
        let url_ = this.baseUrl + "/api/AssetType/GetById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetById(response: HttpResponseBase): Observable<AssetTypeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getByCode(code: string | null | undefined): Observable<AssetTypeDto> {
        let url_ = this.baseUrl + "/api/AssetType/GetByCode?";
        if (code !== undefined)
            url_ += "code=" + encodeURIComponent("" + code) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetByCode(response: HttpResponseBase): Observable<AssetTypeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<AssetTypeInput> {
        let url_ = this.baseUrl + "/api/AssetType/GetForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AssetTypeInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<AssetTypeInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<AssetTypeInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? AssetTypeInput.fromJS(resultData200) : new AssetTypeInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AssetTypeInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: AssetTypeInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/AssetType/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/AssetType/Delete/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class ManufacturerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getByFilter(term: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfManufacturerDto> {
        let url_ = this.baseUrl + "/api/Manufacturer/GetByFilter?";
        if (term !== undefined)
            url_ += "Term=" + encodeURIComponent("" + term) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfManufacturerDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfManufacturerDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfManufacturerDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfManufacturerDto.fromJS(resultData200) : new PagedResultDtoOfManufacturerDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfManufacturerDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<ManufacturerDto> {
        let url_ = this.baseUrl + "/api/Manufacturer/GetById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ManufacturerDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ManufacturerDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<ManufacturerDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<ManufacturerDto>(<any>null);
    }
     ...
     * @return Success
     */
    getByCode(code: string | null | undefined): Observable<ManufacturerDto> {
        let url_ = this.baseUrl + "/api/Manufacturer/GetByCode?";
        if (code !== undefined)
            url_ += "code=" + encodeURIComponent("" + code) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetByCode(response: HttpResponseBase): Observable<ManufacturerDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<ManufacturerInput> {
        let url_ = this.baseUrl + "/api/Manufacturer/GetForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ManufacturerInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<ManufacturerInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<ManufacturerInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ManufacturerInput.fromJS(resultData200) : new ManufacturerInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ManufacturerInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEdit(input: ManufacturerInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Manufacturer/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Manufacturer/Delete/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
...
export class OrganizationUnitServiceProxy {
     ...
     * @return Success
     */
    placeAssetsToOrganizationUnit(input: AssetsToOrganizationUnitInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/OrganizationUnit/PlaceAssetsToOrganizationUnit";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPlaceAssetsToOrganizationUnit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPlaceAssetsToOrganizationUnit(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPlaceAssetsToOrganizationUnit(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class AssetLine implements IAssetLine {
    ...
    static fromJS(data: any): AssetLine {
        data = typeof data === 'object' ? data : {};
        let result = new AssetLine();
        result.init(data);
        return result;
    }
...
export class PagedResultDtoOfAssetLineDto implements IPagedResultDtoOfAssetLineDto {
    totalCount!: number | undefined;
    items!: AssetLineDto[] | undefined;

    constructor(data?: IPagedResultDtoOfAssetLineDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(AssetLineDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfAssetLineDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfAssetLineDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfAssetLineDto {
    totalCount: number | undefined;
    items: AssetLineDto[] | undefined;
}

export class AssetLineDto implements IAssetLineDto {
    code!: string | undefined;
    name!: string | undefined;
    ...
    static fromJS(data: any): AssetLineDto {
        data = typeof data === 'object' ? data : {};
        let result = new AssetLineDto();
        result.init(data);
        return result;
    }
...
export interface IAssetLineDto {
    code: string | undefined;
    name: string | undefined;
    assetType: AssetTypeDto | undefined;
    manufacturer: ManufacturerDto | undefined;
...
export class AssetLineInput implements IAssetLineInput {
    code!: string | undefined;
    name!: string | undefined;
    assetTypeID!: number | undefined;
    manufacturerID!: number | undefined;
    ...
    static fromJS(data: any): AssetLineInput {
        data = typeof data === 'object' ? data : {};
        let result = new AssetLineInput();
        result.init(data);
        return result;
    }
...
export interface IAssetLineInput {
    code: string | undefined;
    name: string | undefined;
    assetTypeID: number | undefined;
    manufacturerID: number | undefined;
...
export class AssetTypeInput implements IAssetTypeInput {
    ...
    static fromJS(data: any): AssetTypeInput {
        data = typeof data === 'object' ? data : {};
        let result = new AssetTypeInput();
        result.init(data);
        return result;
    }
...
export class PagedResultDtoOfManufacturerDto implements IPagedResultDtoOfManufacturerDto {
    totalCount!: number | undefined;
    items!: ManufacturerDto[] | undefined;
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(ManufacturerDto.fromJS(item));
            }
        }
    }
...
export class AssetsToOrganizationUnitInput implements IAssetsToOrganizationUnitInput {
    ...
    constructor(data?: IAssetsToOrganizationUnitInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["assetIds"] && data["assetIds"].constructor === Array) {
                this.assetIds = [];
                for (let item of data["assetIds"])
    ...
    static fromJS(data: any): AssetsToOrganizationUnitInput {
        data = typeof data === 'object' ? data : {};
        let result = new AssetsToOrganizationUnitInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (this.assetIds && this.assetIds.constructor === Array) {
            data["assetIds"] = [];
